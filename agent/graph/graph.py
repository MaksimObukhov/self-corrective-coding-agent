...
from agent.chains.debugger import DebuggerAgent
...
debugger_agent = DebuggerAgent(llm)
...
workflow.add_edge("debugger_agent", "test_evaluation")
workflow.add_conditional_edges(
    "test_evaluation", next_step,
    {
        "requires_debugging": "debugger_agent",
        "max_k_iterations": "test_gen_agent",
        "max_t_iterations": END,
        "passed_all": END,
    }
)
